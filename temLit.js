...
// let highScore = fullName + " " + "has the score of " + score;
let highScore = `${fullName} has the score of ${score}`;
...
console.log(`concatination is easy when using templateliterals, I can even embed numbers and not have to worry about spacing`);

//console log the three strings above and add a third string that includes the add var
console.log(`concatination is easy when using templateliterals, I can even embed numbers and not have to worry about spacing ${add}`);